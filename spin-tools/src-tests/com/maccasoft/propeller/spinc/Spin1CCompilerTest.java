...
class Spin1CCompilerTest {
    ...
    void testObjectMethodCall() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00010 00010       06 02 01       CALL_OBJ_SUB (2.0)\n"
            + "' }\n"
    ...
    void testObjectInstances() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00014 00014       06 02 01       CALL_OBJ_SUB (2.0)\n"
            + "'     o2.start(3, 4);\n"
            + "00017 00017       01             ANCHOR\n"
            + "00018 00018       37 21          CONSTANT (3)\n"
            + "0001A 0001A       37 01          CONSTANT (4)\n"
            + "0001C 0001C       06 03 01       CALL_OBJ_SUB (3.0)\n"
            + "' }\n"
    ...
    void testObjectArrayMethodCall() throws Exception {
        ...
        Assertions.assertEquals(""
            ...
            + "00015 00015       07 02 01       CALL_OBJ_SUB (2.0) (indexed)\n"
            + "'     o[1].start(3, 4);\n"
            + "00018 00018       01             ANCHOR\n"
            + "00019 00019       37 21          CONSTANT (3)\n"
            + "0001B 0001B       37 01          CONSTANT (4)\n"
            + "0001D 0001D       36             CONSTANT (1)\n"
            + "0001E 0001E       07 02 01       CALL_OBJ_SUB (2.0) (indexed)\n"
            + "' }\n"
